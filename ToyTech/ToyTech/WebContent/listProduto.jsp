						...
						<table width="100%" border="1" cellpadding="2" cellspacing="0">
							...
							<tr>
								<th colspan="8" style="text-align: right;">
									<a href="cadProduto.jsp"><img src="icon/novo.png" style="width: 20px;">Adicionar Novo</a>
								</th>
							</tr>
							...
							<tr>
								...
								<td style="text-align: center;"><a href="ServletProduto?cmd=atu&id=<%=p.getIdProduto()%>"><img src="icon/editar.png" style="width: 20px; position: center;"></a></td>
								<td style="text-align: center;"><a href="ServletProduto?cmd=exc&id=<%=p.getIdProduto()%>"><img src="icon/excluir.png" style="width: 20px;"></a></td>
							</tr>
							<%
								}
							%>				
