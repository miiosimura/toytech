	         ...
	         <div class="container-fluid">	
	          ...
	          <jsp:useBean id="produto" scope="session" class="br.com.toytech.bean.Produto" />
	          	...
	          	<form action="ServletProduto?cmd=excluir" method="post">
					 <tbody>
						 <tr>
						 	<th colspan="2"><h4>Excluir Produto</h4><br /></th>
						 </tr>
						 <tr>
							...
							<td><input type="textarea" name="descricao" size="10" maxlenght="10" style="width: 400px; height: 150px;" value="<%=produto.getDescricao()%>" readonly="readonly"/></td>
