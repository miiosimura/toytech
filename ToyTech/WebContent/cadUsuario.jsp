	        ...
	        <div class="span9">
	         <div class="container-fluid">	
				...
				<form action="ServletUsuario" method="get">
					 ...
					 <tbody>
						 <tr>
						 	<th colspan="2"><h4>Cadastrar Usuário</h4><br /></th>
						 </tr>
						 <tr>
							<th><h4>Nome do Usuario</h4></th>
							<td><input type="text" name="nome" size="10" maxlenght="10" /></td>
							
							<th><h4>Username</h4></th>
							<td><input type="text" name="username" size="10" maxlenght="10" /></td>
