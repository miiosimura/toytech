	        ...
	        <div class="span9">
	         <div class="container-fluid">	
	          ...
	          <jsp:useBean id="categoria" scope="session" class="br.com.toytech.bean.Categoria" />
	          	...
	          	<!-- CONTEUDO AQUI -->
	          	<form action="ServletCategoria?cmd=atualizar" method="post">
					 <tbody>
						 <tr>
						 	<th colspan="2"><h4>Atualizar Categoria</h4><br /></th>
						 </tr>
						 <tr>
							...
							<td><input type="text" name="nomeCategoria" size="10" maxlenght="10" value="<%=categoria.getNomeCategoria()%>"/></td>
