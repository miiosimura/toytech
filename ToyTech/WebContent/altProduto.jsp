	      ...
	      <div class="row-fluid">
	        ...
	        <div class="span9">
	         <div class="container-fluid">	
	          ...
	          <jsp:useBean id="produto" scope="session" class="br.com.toytech.bean.Produto" />
	          
	          	<!-- CONTEUDO AQUI -->
	          	<form action="ServletProduto?cmd=atualizar" method="post">
					 <tbody>
						 <tr>
						 	<th colspan="2"><h4>Atualizar Produto</h4><br /></th>
						 </tr>
						 <tr>
							...
							<td><input type="text" name="nomeProduto" size="10" maxlenght="10" value="<%=produto.getNomeProduto()%>"/></td>
							
							<th><h4>Categoria do Produto</h4></th>
							<td><input type="text" name="idCategoria" size="10" maxlenght="10" value="<%=produto.getIdCategoria()%>"/></td>
							
							<th><h4>Preço Unitário</h4></th>
							<td><input type="text" name="precoUnitario" size="10" maxlenght="10" value="<%=produto.getPrecoUnitario()%>" /></td>
							
							<th><h4>URL da Imagem</h4></th>
							<td><input type="text" name="imgProduto" size="10" maxlenght="10" value="<%=produto.getImgProduto()%>" /></td>
							 
							<th><h4>Descrição do Produto</h4></th>
							<td><input type="textarea" name="descricao" size="10" maxlenght="10" style="width: 400px; height: 150px;" value="<%=produto.getDescricao()%>" /></td>
